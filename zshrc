...
# regardless of PATH order because the system /usr/bin/python3 lacks the module.
...
# Pi has its own instructions and skills, not other coding harnesses' defaults.
