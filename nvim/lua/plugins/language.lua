local work_root = "/Users/eric/dev/work"
local work_biome = work_root .. "/node_modules/.bin/biome"
local work_python = "/Users/eric/.venvs/work/bin/python"
local work_ruff = "/Users/eric/.venvs/work/bin/ruff"
...
local function format_enabled(bufnr)
  ...
  -- WORK deltas are append-only history; never reformat them.
...
return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.lsp.config("ruff", {
        cmd = { command(work_ruff, "ruff"), "server" },
        init_options = {
          settings = {
            lineLength = 100,
          },
      ...
      vim.lsp.config("basedpyright", {
        settings = {
          ...
          python = {
            pythonPath = executable(work_python) and work_python or nil,
          },
        },
      })
      ...
      vim.lsp.config("biome", {
        cmd = { command(work_biome, "biome"), "lsp-proxy" },
  ...
  },
  {
    ...
    opts = {
      ...
      formatters = {
        biome = {
          command = command(work_biome, "biome"),
          require_cwd = true,
          cwd = function()
        ...
        ruff_fix = {
          command = command(work_ruff, "ruff"),
        },
        ruff_format = {
          command = command(work_ruff, "ruff"),
        },
  ...
  },
  {
    ...
    config = function()
      ...
      -- nvim-lint defaults sqlfluff to ANSI dialect; WORK is Postgres 15.
