...
test('Pi Markdown remains lean and maintenance stays on demand', async () => {
  ...
  assert.ok(sizes.reduce((sum, size) => sum + size, 0) < 33000, 'all owned Markdown budget, including new files');
